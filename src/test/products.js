...
describe('MENU', () => {
  ...
  before((done) => {
    Pool.query(('DELETE from products where name = \'pop corn\''))
      .then(() => {
        done();
      }).catch(() => done());
  });
      ...
      return chai.request(app)
        ...
        .then((res) => {
          ...
          res.body.errors.should.have
            .property('quantity').eql('Product quantity is required');
        })
        .catch((err) => {
          throw err;
        });
    ...
    it('should throw error if product price is empty', () => {
      ...
      return chai.request(app)
        ...
        .then((res) => {
          ...
          res.body.should.have.property('errors').to.be.a('object');
          res.body.errors.should.have
            .property('price').eql('Product Price field is required');
        })
        .catch((err) => {
          throw err;
        });
    ...
    it('should throw error if product description is empty', () => {
      ...
      return chai.request(app)
        ...
        .then((res) => {
          ...
          res.body.should.have.property('errors').to.be.a('object');
          res.body.errors.should.have
            .property('description').eql('Product Description is required');
        })
        .catch((err) => {
          throw err;
        });
    ...
    it('should throw error if name length < 2 or > 30', () => {
      ...
      return chai.request(app)
        ...
        .then((res) => {
          ...
          res.body.should.have.property('errors').to.be.a('object');
          res.body.errors.should.have
            .property('name').eql('Product name must be between 2 and 30 characters');
        })
        .catch((err) => {
          throw err;
        });
    ...
    it('should throw error if product image is invalid', () => {
      ...
      return chai.request(app)
        ...
        .then((res) => {
          ...
          res.body.should.have.property('errors').to.be.a('object');
          res.body.errors.should.have
            .property('productImg').eql('Not a valid product url');
        })
        .catch((err) => {
          throw err;
        });
    ...
    it('should throw error if product descriptions is few words', () => {
      ...
      return chai.request(app)
        ...
        .then((res) => {
          ...
          res.body.should.have.property('errors').to.be.a('object');
          res.body.errors.should.have
            .property('description').eql('Descriptions must be more than 20 characters');
        })
        .catch((err) => {
          throw err;
        });
    ...
    it('should throw error if product price is not a number', () => {
      ...
      return chai.request(app)
        ...
        .then((res) => {
          ...
          res.body.should.have.property('errors').to.be.a('object');
          res.body.errors.should.have
            .property('price').eql('Price must be a floating point number');
        })
        .catch((err) => {
          throw err;
        });
  ...
  describe('PUT /menu/products/:productId', () => {
    ...
    it('should update product details', () => {
      ...
      return chai.request(app)
        .put(`/api/v1/menu/products/${productId}`)
        .send(product)
        .set('Authorization', token1)
        .then((res) => {
          res.should.have.status(200);
