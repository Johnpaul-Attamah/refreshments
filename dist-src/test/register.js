...
describe('User Validation', () => {
  before(done => {
    _dbConnection.default.query('DELETE from users where email = \'test@gmail.com\'').then(() => {
      done();
    }).catch(() => done());
  });
  describe('POST /auth/signup', () => {
    it('Should signup user and return the user object', () => {
      ...
      return _chai.default.request(_index.default).post('/api/v1/auth/register').send(user).then(res => {
        res.should.have.status(200);
        res.body.should.be.a('object');
